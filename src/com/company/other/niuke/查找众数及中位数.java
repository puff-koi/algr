...
//7
    public static void main(String[] args) {
        ...
        Integer[] arrMid = new Integer[list.size()];
        list.toArray(arrMid);
        System.out.println(Arrays.toString(arrMid));
        int mid = 0;
        if (arrMid.length%2 == 0){
            mid = (arrMid[arrMid.length/2-1] + arrMid[arrMid.length/2])/2;
        }else {
            mid = arrMid[arrMid.length/2];
        }
